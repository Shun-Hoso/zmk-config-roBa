...
└─────┴─────┴─────┴─────┴─────┘│/NAV│└───┘─────┴─────┘     │     └─────┘
                                └────┘
小指側 ──────────────────→ 中央（割れ目）
[Shift] [Alt] [Cmd] [かな] [Space] [英数]  ← 左手の親指キー
...
#### 4. 日本語 ↔ 英語 の切り替え
```
「かな」キー（Space の左隣）をタップ → かな入力に切替
「英数」キー（Space の右隣、割れ目の直前）をタップ → 英数入力に切替
...
| NAV（「英数」キー ホールド） | ブラウザ/VSCode タブ切替 |
...
```
                    ...
                    └──┬───┬───┬──┘
           ┌──────────┘   │   └──────────┐
     「英数」hold     「Space」hold    「Enter」hold
     ┌─────┴─────┐ ┌─────┴─────┐ ┌─────┴─────┐
     │  Layer 1  │ │  Layer 2  │ │  Layer 3  │
     │  NAV      │ │  NUM      │ │  FUNC     │
     └───────────┘ └───────────┘ └───────────┘

     I 長押し        トラックボール動かす   「かな」hold
     ┌─────┴─────┐ ┌─────┴─────┐ ┌─────┴─────┐
...
| レイヤー | 切替方法 | 用途 |
|----------|----------|------|
| **NAV** (1) | 「英数」（Spaceの右隣）を **押しっぱなし** | 矢印キー、HOME/END、タブ切替 |
...
| **BT** (6) | 「かな」（Spaceの左隣）を **押しっぱなし** | Bluetooth 接続管理 |
...
**切替**: 「英数」キー（Space の右隣、割れ目の直前）を押しっぱなし
