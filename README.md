...
#### 4. 日本語 ↔ 英語 の切り替え
```
左親指「かな」キー（タップ）→ かな入力に切替（LANGUAGE_2）
左親指「英数」キー（タップ）→ 英数入力に切替（LANGUAGE_1）
...
| レイヤー | 切替方法 | 用途 |
|----------|----------|------|
| **NAV** (1) | 「英数」キーを **押しっぱなし** | 矢印キー、HOME/END、タブ切替 |
| **NUM** (2) | 「Space」キーを **押しっぱなし** or **ロック** | 数字入力、プログラミング記号 |
| **FUNC** (3) | 「Enter」キーを **押しっぱなし** | F キー、ページ移動 |
| **MOUSE** (4) | トラックボールを動かすと **自動遷移** | マウスクリック |
| **SCROLL** (5) | I キーを **押しっぱなし** | トラックボールがスクロールに変化 |
| **BT** (6) | 「かな」キーを **押しっぱなし** | Bluetooth 接続管理 |
